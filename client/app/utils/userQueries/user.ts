...
export const updatePassword = ()=>{
  const query = useMutation({
    ...
    mutationFn: async (object:{id:string, token:string,password:any})=>{
      const result =  await axios.put(`http://localhost:3001/auth/update-password/${object.id}/${object.token}`,{
