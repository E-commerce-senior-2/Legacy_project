  ...
  return (
    <>
      <div className="max-w-md mx-auto flex justify-center items-center flex-col">
        <h3 className="text-center font-extrabold no-underline md:underline">
          About us{" "}
        </h3>
        <h1 className="text-center text-6xl text-white font-sans font-bold">
          Who we are.
        </h1>
        <p className="flex-col justify-center items-center text-slate-600 m-6 text-center ">
          <strong>FancyMama</strong>
          {"  "}
          is your go-to destination for all things fashion and luxury. We're a
          curated platform that brings together talented creators and fashion
          enthusiasts. Whether you're discovering the latest trends or
          showcasing your creations,
          <strong>FancyMama</strong> is where style meets innovation. Join us in
          celebrating the diverse world of fashion and indulge in a unique
          shopping experience that reflects your individuality
        </p>
        <div className="flex justify-center items-center">
          <button className="bg-[#733709bc] p-2 text-white font-sans w-16">
            More
          </button>
        </div>
      </div>
      ...
      <div className="lg:flex-row flex flex-col items-center justify-between">
        <div className="mt-20 relative flex flex-col">
          <h3 className=" font-extrabold no-underline md:underline">
            Since 2014
          </h3>
          ...
          <p className="flex-col text-slate-600 mt-2 mb-6 justify-center items-center w-full md:w-96 text-center">
            At <strong>FancyMama</strong>, we curate a world of opulence where
            creators unveil their bespoke fashion and luxury collections.
            Immerse yourself in an exclusive realm, discovering unique pieces,
            and effortlessly connecting with your preferred designers and
            brands. With FancyMama, your journey transcends conventional
            shopping; it's a personalized experience, a celebration of
            individuality,and a seamless blend of style and sophistication.
            Indulge in the extraordinary <strong>FancyMama</strong>, where
            luxury meets your unique fashion narrative.
          </p>
          <div className="flex ml-24">
            <button className="bg-[#733709bc] p-2 text-white font-sans w-16 mb-20 ml-14">
              More
            </button>
          </div>
        </div>
        ...
        >
          ...
          <img
            style={{
              ...
              top: 25,
              position: "absolute",
              boxShadow: "0px 0px 34px rgba(0, 0, 0, 0.35)",
              borderRadius: 10,
            }}
          ...
          <img
            ...
            src="https://i.pinimg.com/564x/e3/00/c8/e300c837d33e03f39104dbf47b931b1f.jpg"
          />
        </div>
      </div>
      ...
      <div className="lg:flex-row-reverse flex flex-col items-center justify-between">
        <div className="mt-20 relative flex flex-col justify-center">
          ...
          <p className="flex-col text-slate-600 mt-5 mb-6 justify-center items-center w-full md:w-96 text-center">
            Established 2014, <strong>FancyMama</strong> emerged as a vision to
            redefine fashion exploration. From the outset, we aimed to curate a
            unique space where creators and fashion aficionados unite. Join us
        ...
        >
          <img
            ...
            src="https://mygemma.com/cdn/shop/articles/mygemma-WPD-Top-Blog-Image-49.png?v=1695913199"
          />
          <img
            style={{
              width: 324,
            ...
            src="https://pianoluigi.com/cdn/shop/files/versace-la-medusa-bag-women-piano-luigi-1_800x.jpg?v=1691740345"
          />
          <img
            style={{
              width: 324,
            ...
            src="https://www.dior.com/couture/ecommerce/media/catalog/product/N/L/1666251919_M0446CRIW_M928_E01_GH.jpg"
          />
        </div>
      </div>
