...
const Footer = () => {
  return (
    <>
      <footer className="relative mx-w-full z-10 bg-[#6e57403c] pb-10 pt-20 dark:bg-dark lg:pb-6 lg:pt-[28px]">
        <div className="container px-10">
          <div className="-mx-4 flex items-center justify-center flex-wrap mx-w-full">
            ...
            <LinkGroup header="About">
              <NavLink link="/explore" label="Product" />
              <NavLink link="/#" label="Ressource" />
              <NavLink link="/#" label="Team & Condition" />
              <NavLink link="/#" label="FAQ" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/About" label="Our Team" />
            ...
            <div className="relative justify-center items-center">
              <LinkGroup header="Contact">
                <NavLink link="/#" label="FancyMama@gmail.com" />
              </LinkGroup>
              <div className="flex justify-around items-center pt-[-5px]]">
                <FaDiscord />
                <FaYoutube />
                <FaInstagram />
              </div>
