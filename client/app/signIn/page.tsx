...
const Signin: React.FC = () => {
  ...
  const emails = useRef<HTMLInputElement | null>(null);
  ...
  return (
    <div className=" flex h-screen flex-col items-center justify-center lg:flex-row  ">
      ...
      <div className=" ml-10 h-fit  w-fit flex-col rounded-[10px] bg-white bg-opacity-20 p-5">
        ...
        <div>
          <span className=" font-['SF Pro Display'] text-lg font-normal tracking-tight text-gray-600">
            Are you Creator?
          </span>
          <span className="font-['SF Pro Display'] text-lg font-normal tracking-tight text-[#733709]">
            {" "}
          </span>
          <span
        ...
        {desplayp && (
          <button
            onClick={() => setDesplayp(false)}
            className="mg-5 float-right  mt-3 rounded-full  bg-[#733709] px-4 text-white transition duration-200 ease-in-out hover:bg-[#DC9D6D] focus:outline-none active:bg-[#B27F58]"
          >
            continue
          </button>
        )}
        {desplayp && (
          <div className=" mb-2 mt-12 flex items-center justify-center">Or</div>
        )}
        {!desplayp && (
          <div className=" mb-2  flex items-center justify-center">Or</div>
        )}
        <div className="flex items-center justify-center">
          <div>
            <button
              onClick={handlegoogle}
              className="mt-1 flex w-full items-center justify-center rounded-lg bg-white px-20 py-2 text-center text-base font-semibold text-gray-700 shadow-md transition duration-200 ease-in hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200"
            >
              <svg
                viewBox="0 0 24 24"
                height="25"
            ...
            <button className="mt-4 flex w-full items-center justify-center rounded-lg bg-white px-20 py-2 text-center text-base font-semibold text-gray-700 shadow-md transition duration-200 ease-in hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200">
              <svg
                viewBox="0 0 30 30"
                height="30"
                width="30"
