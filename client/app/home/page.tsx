          ...
          {follow && (
            <button
              onClick={() => {
                ...
                removeFollow(id), setFollow(false);
              }}
...
const Quetions = () => {
  ...
  return (
    <div className="flex flex-col lg-flex-row justify-center items-center">
      ...
      <button className="bg-[#70565099] item-center justify-center p-8 font-extrabold font-['Poppins'] mb-12 text-[#734532] rounded-full "> Confirm Your Quetions </button>
    </div>
  );
};
