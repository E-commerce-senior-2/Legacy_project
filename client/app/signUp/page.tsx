...
const Signup: React.FC = () => {
  ...
  return (
    <div className="flex justify-center flex-col lg:flex-row items-center h-screen">
      <div>
        <Image className="h-[400px]" src={Logo} alt="Signin" />
      </div>
      ...
      <div className="flex-col w-fit h-[450px] ml-10 bg-white bg-opacity-20 rounded-[10px] p-5">
        ...
        <div>
          ...
          <span className="text-[#733709] text-lg font-normal font-['SF Pro Display'] tracking-tight">
            {" "}
          </span>
          <span
          ...
          <span
            ...
            onClick={() => {
              setRole("user") 
              toast.success("You are a User Now ! ");
            }}
          >
            /No 
          <Toaster richColors />
