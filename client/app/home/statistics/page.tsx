  ...
  return (
    <div className=" flex flex-col gap-7 ">
      <div className=" flex flex-col gap-3 px-6 text-center w-10/12 mx-auto mt-20">
        ...
        <p className="text-base font-medium leading-7 text-[#FFE3E0]">
          The top NFT________,Nfs on ranked by volume,floor price and other
          statistics
        </p>
      </div>
      ...
      <div className="flex flex-row gap-[430px]">
        ...
        <div className="sm:w-full md:w-[362px] h-[47px] justify-start items-start gap-10 inline-flex">
          <div className="sm:w-full md:w-[171px] h-[47px] relative">
            ...
            <div className="left-[20px] top-[14px] absolute flex items-center text-white text-base font-normal font-['SF Pro Display']">
              Last 7 Days <IoIosArrowDown />
            </div>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody className="">
                <tr className="text-gray-700">
                  ...
                  <td className="px-4 py-5 text-ms font-semibold flex items-center border-b border-gray-300">
                    <TiArrowUnsorted />
                    27.966
                  </td>
                  <td className="px-4 py-3 text-xs border-b border-gray-300">
                    <span className="px-2 py-1 font-semibold leading-tight text-green-700 rounded-sm">
                      {" "}
                      +92.96{" "}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-3 border-b border-b-gray-300">
                    <div className="flex items-center text-sm">
                      <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://i.pinimg.com/736x/27/4e/de/274edea0e3bfd0a2e0211304b8b0532e--behance-net-christian-dior.jpg"
                          alt=""
                          loading="lazy"
                        />
                        <div
                  ...
                  <td className="px-4 py-3 border-b border-b-gray-300">
                    <div className="flex items-center text-sm">
                      <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://th.bing.com/th/id/R.142fc8c8ca87f2a7cc54cfd9aab6d221?rik=XZrLISEVtParfw&pid=ImgRaw&r=0"
                          alt=""
                          loading="lazy"
                        />
                        <div
                      ...
                      <div>
                        <p className="font-semibold flex item-center text-black">
                          pinko <MdOutlineVerified />
                        </p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3 border-b border-b-gray-300">
                    <div className="flex items-center text-sm">
                      <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://www.logolynx.com/images/logolynx/78/782007807df7f0e4107cd0332c6c53c5.jpeg"
                          alt=""
                          loading="lazy"
                        />
                        <div
                  ...
                  <td className="px-4 py-3 border-b border-b-gray-300">
                    <div className="flex items-center text-sm">
                      <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://th.bing.com/th/id/R.9eb3c80553ca98c344c9c86e0e55545b?rik=yRKoSeAG0e3mrw&riu=http%3a%2f%2fdgsport.com.au%2fwp-content%2fuploads%2f2017%2f01%2fDG-ON-ORANGE.png&ehk=zNea7AK7vs9GUku6voApyK8zLU662CqjxnHfWt8Lobk%3d&risl=&pid=ImgRaw&r=0"
                          alt=""
                          loading="lazy"
                        />
                        <div
                  ...
                  <td className="px-4 py-3 border-b border-b-gray-300">
                    <div className="flex items-center text-sm">
                      <div className="relative w-8 h-8 mr-3 rounded-full md:block">
                        <img
                          className="object-cover w-full h-full rounded-full"
                          src="https://th.bing.com/th/id/OIP.OehDiGfDIj233mAKCjIanwHaEo?rs=1&pid=ImgDetMain"
                          alt=""
                          loading="lazy"
                        />
                        <div
                      ...
                      <div>
                        <p className="font-semibold flex items-center text-black">
                          Alexander Mcqueen <MdOutlineVerified />
                        </p>
                      </div>
                    </div>
                  </td>
